...
public class HoodiesAdapter extends RecyclerView.Adapter<HoodiesAdapter.MyViewHolder>{

    private int[] image;
    private String[] name;

    public HoodiesAdapter(int[] image, String[] name) {
        this.image = image;
        this.name = name;
    ...
    @NonNull
    @Override
    public HoodiesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card, parent, false);

        return new HoodiesAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HoodiesAdapter.MyViewHolder holder, int position) {
